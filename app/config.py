...
class GlobalSettings(BaseSettings):
    ...
    # 应用信息
    app_name: str = Field(default="vertu-info-search", description="应用名称")
    app_version: str = Field(default="1.0.0", description="应用版本")
    app_description: str = Field(default="vertu info search", description="应用描述")
    ...
    port: int = Field(default=8010, description="API 端口")
    ...
    # meilisearch 配置
    meilisearch_host: str = Field(default="", description="Meilisearch 主机")
    meilisearch_api_key: str = Field(default="", description="Meilisearch API 密钥")
